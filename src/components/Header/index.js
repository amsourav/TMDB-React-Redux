					...
					<div className="Header__wrap">
						...
						</div>
						{
							...
							<div className="Header__right">
								...
								<div className="Header__item" onClick={this.injectSearchForm}>
							...
							<div className="Header__right">
								<div className="Header__item">
									<input placeholder="Search..." value={this.props.search.payload.term} style={{marginRight: 15}} onChange={this.inputHandler} />
									<span onClick={this.hideSearchForm}><FontAwesome name="times" /></span>
								</div>
							</div>
						}
					</div>
