...
class App extends React.Component {
	...
	render() {
		...
		if (this.props.sortedMovies.type !== UNSORT) {
			MovieCardsDiv = this.props.sortedMovies.payload
				? this.props.sortedMovies.payload.map(data => {
						if (data !== null) {
			...
			MovieCardsDiv = this.props.search.payload.filteredMovies.length
				? this.props.search.payload.filteredMovies.map(data => {
						return <MovieCard key={data.id} data={data} />;
					})
			...
			MovieCardsDiv = this.props.movies.length
